...
const T = {
  fr: {
    ...
    prob6: "Diagnostiquer les perturbations de qualité de l'énergie électrique — harmoniques, creux de tension, flicker et déséquilibres",
  ...
  en: {
    ...
    prob6: 'Diagnose power quality disturbances — harmonics, voltage sags, flicker and unbalance (IEEE 1159 / IEEE 519-2022)',
    services_tag:   'Expertise',
  ...
  ar: {
    ...
    prob6: 'تشخيص اضطرابات جودة الطاقة الكهربائية — التوافقيات، انخفاضات الجهد، الرفرفة وعدم التوازن (IEEE 1159 / IEEE 519-2022)',
    services_tag:   'خبرتنا',
